                            ...
                            {show &&
                                <>
                                    ...
                                    <article className="portfolio-item">
                                        ...
                                        <h3>BrandColors React-Tailwind Clone (Mobil Desteklemiyor)</h3>
                                        <div className="portfolio-item-cta">
                                    ...
                                    <article className="portfolio-item">
                                        ...
                                        <div className="portfolio-item-cta">
                                            ...
                                            <a className="btn btn-primary" target="_blank" rel="noreferrer" href="https://react-redux-thunk-todo.netlify.app/">Demo İçin Tıklayın  </a>
                                        </div>
