    ...
    <section id="about">
      ...
      <div className="container about-container">
        ...
        <div className="about-content">
          ...
          <p>
            {language === "tr" ? " 1995 Sinop-Merkez doğumluyum, 2018 Haziran ayında işletme fakültesinden mezun olduktan sonra çocukluğumdan beri ilgi duyduğum ve dünyanın geleceğine yön vereceğini düşündüğüm yazılım alanına yöneldim, bu yönde ilk adımım Sakarya Üniversitesi Bilişim Sistemleri bölümünde yüksek lisans yapmaya başlamak oldu. Mezun olup Askerliğimi yaptıktan sonra kendimi geliştirmeye başladım." : "I was born in 1995 in Sinop, and after graduating from the business faculty in June 2018, I tended to the software field which I have been interested in programming which  will shape the future of the world since childhood. In this direction My first step was to start a Master's degree in Computer Systems at Sakarya University. After I completed Master's degree about information systems, I served out miliary service. I commenced to work software developing skills."}

          </p>
          <p className="detail">
            {language === "tr" ? "Yaklaşık 9-10 aydır front-end alanında kendimi geliştirmekteyim. Html Css ve Javascript'te belirli bir seviyeye geldikten sonra React öğrenip geliştirmeler yapmaya başladım. Git, npm, vscode, visual studio gibi araçları kullanıyorum,  Redux, React-Router-Dom, Formik, Yup gibi paketleri ve Context Api kullanabiliyorum. Seyahat engelim bulunmamaktadır." : "    I have been developing myself about the front-end field  about approximately 9-10 months. After I reached a certain level in Html Css and Javascript, I started learning React and making improvements., I started learning React and making improvements. I can use tools as like Git, npm, vscode, and visual studio, and I am able to use packages like Redux, React-Router-Dom, Formik, Yup, and the Context Api. I have no travel restrictions."}
          </p>
          <p className="detail">
